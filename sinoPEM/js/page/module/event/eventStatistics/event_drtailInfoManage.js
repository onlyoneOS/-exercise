 function eventdr(){
		...
		$(document).ready(function() {
			...
			var url = ctx+"/eventDailyManageInfo/getAll?roomName="+roomName+"&startTime="+startTime;
	...
	function export_Page() {
		...
		var url = ctx + "/eventDailyManageInfo/exportExcel?tmp="+ Math.random() + "&startTime="+ $('#beginTime').val()+"&roomName="+ $('#roomName').val()+"&exportId="+$('#_exportId').val();
