function vdata(){
		...
		$(document).ready(function() {
			...
			var url = ctx+"/eventDailyManageInfo/getDevAll?devName="+devName+"&startTime="+startTime;
	...
	function export_Page() {
		...
		var url = ctx + "/eventDailyManageInfo/exportExcel?tmp="+ Math.random() + "&startTime="+ $('#beginTime').val()+"&devName="+ $('#devName').val();
