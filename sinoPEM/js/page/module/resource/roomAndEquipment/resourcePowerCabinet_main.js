define(function(require, exports, module) {
	...
	require("DT_bootstrap");
		...
		exports.init = function(){
			...
			$(document).ready(function() {
				...
				var url = ctx+"/powerCabinet/getAll";
		...
		//			] ,
					...
					*/
					...
					$("#addbutton").append("<a id='createbutton' href='#myModal1' role='button'  data-toggle='modal'class='btn btn-primary'>添加配电柜</a>");
	...
	function delRoomDevice(id){
		      ...
		      // confirm("确定删除吗？");
	            ...
	            $.ajax({
	            	 url:"/sino/powerCabinet/delPowerDev?Id="+id,  // 提交的页面
		                data: "", // 从表单中获取数据
	...
	function modiRoomDevice(id){
	    ...
	    var mid = id;
	    var murl = ctx+"/powerCabinet/modi?deviceId="+mid;
		$('.edit_list').empty();
//		var url = ctx+"/roomDevice/getAllRoomDev?roomdevId="+mid;
	...
	function create(options){
				...
				var url = ctx+"/powerCabinet/add?tmp="+Math.random();
				$('#edit_list').empty();
